...
const dict = {
  ru: {
    ...
    "home.searchFound": "Найдено",
    "home.searchNothing": "Ничего не найдено",
    "home.study": "Учить",
    ...
    "create.collection": "Коллекция",
    "create.collectionDefault": "Моя коллекция (по умолчанию)",
    "create.prev": "← Назад",
    "create.next": "Вперёд →",
    ...
    "dr.title": "Отложенное припоминание",
    "dr.offDesc": "Включите режим, чтобы переводить слова из короткой памяти в долгую через возрастающие интервалы.",
    "dr.openSettings": "Открыть настройки",
    "dr.settings": "Настройки",
    "dr.ready": "К повтору",
    "dr.upcoming": "В очереди",
    "dr.retention": "Удержание",
    "dr.mastered": "Освоено",
    "dr.wordReady": "слово готово",
    "dr.wordsReady": "слов готовы",
    "dr.toRecall": "к припоминанию",
    "dr.decksSuffix": "колод",
    "dr.startSession": "Начать сессию",
    "dr.nextReviewPrefix": "Следующий повтор",
    "dr.nextReviewSuffix": ". Заглядывайте позже — мы напомним.",
    "dr.empty": "Запланированных слов пока нет. Добавьте карточки — они автоматически встанут в очередь.",
  },
  en: {
    "nav.decks": "Decks",
