...
const dict = {
  en: {
    ...
    "create.import.title": "Import words",
    "create.import.hint":
      "Paste words one per line, with or without translations, or upload a clear image.",
    "create.import.placeholder": "example - translation\nimportant\ntravel plans\nmake a decision",
    "create.import.list": "Import list",
    "create.import.image": "Upload image",
    "create.import.importing": "Importing…",
