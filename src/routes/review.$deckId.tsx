...
function ReviewPage() {
  ...
  useEffect(() => {
    if (!deckCards) return;
    setQueueIds(dueCardIds(deckId, deckCards));
  }, [deckId, deckCards]);
        ...
        {empty ? (
          <div className="rounded-3xl border border-border bg-card p-12 text-center">
            ...
            <p className="mt-3 text-muted-foreground">
              All words in this deck are still fresh. Check back later — the system will tell you
              when to review.
            </p>
            <div className="mt-8 flex justify-center gap-3">
              ...
              <Button asChild className="rounded-full">
                <Link to="/type/$deckId" params={{ deckId: deck.id }}>
          ...
          <div className="rounded-3xl border border-border bg-card p-12 text-center">
            ...
            <div className="mt-8 flex justify-center gap-3">
              ...
              {isOnline ? (
                <Button asChild className="rounded-full">
                  <Link to="/feedback/$deckId" params={{ deckId: deck.id }}>
          ...
          <>
            <div className="mb-8">
              <div className="flex justify-between text-xs text-muted-foreground mb-2">
                <span>
                  {idx + 1} / {total} · stage: {STAGE_NAMES[stats[current.id]?.stage ?? 0]}
                </span>
                <span>
